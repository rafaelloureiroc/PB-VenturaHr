		...
		<div class="container px-4 px-lg-5 h-100">
			<div
				...
				<div class="col-lg-8 align-self-end">
					<h1 class="text-white font-weight-bold">VenturaHr</h1>
					<hr class="divider" />
				</div>
				<div class="col-lg-8 align-self-baseline">
					<p class="text-white-75 mb-5">Bem vindos ao VenturaHr, um
						sistema que cadastra candidatos, vagas e os associa!</p>
					<a class="btn btn-primary btn-xl" href="#about">Como usar</a>
				</div>
			</div>
		</div>
	</header>
		...
		<div class="container px-4 px-lg-5">
			<div class="row gx-4 gx-lg-5 justify-content-center">
				<div class="col-lg-8 text-center">
					<h2 class="text-white mt-0">Forma de utilização!</h2>
					<hr class="divider divider-light" />
					<p class="text-white-75 mb-4">Gostariamos de deixar claro como
						se utiliza o sistema. Primeiramente, o sistema é aberto pela
						empresa, a qual registra as vagas, após o cadastro
						de vagas, o login aberto unicamente pelas empresas para contratar
						sera compartilhado pelo meio da mesma e divulgado aos candidatos
						para que os mesmos possam adicionar suas credenciais ao sistema, e
						por fim se candidatar às vagas disponiveis.!</p>
